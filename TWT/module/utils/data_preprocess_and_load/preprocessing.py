...
def main():
    ...
    dataset_name = 'ADNI'
    load_root = 'G:\BaiduSyncdisk\Alzheimer\ADNI\Early_diagnosis\AD\\finished' # This folder should have fMRI files in nifti format with subject names. Ex) sub-01.nii.gz
    save_root = f'D:\Project\AD\SwiFT-main\project\data\\xxx'
