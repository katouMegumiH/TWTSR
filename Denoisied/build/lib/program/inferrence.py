...
class fmri_inferrence:
    ...
    def run(self):
        ...
        with h5py.File(self.output_file, "w") as file_handle:    # 创建输出 F5 文件
            ...
            # We are looping across the volume # 遍历每个体素形成输入
