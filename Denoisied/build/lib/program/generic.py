...
# ClassLoader允许从可用的对象库中选择和创建特定的Type和Name对象。
# 使用json文件中的参数来创建该对象的特定实例。 
# 它返回该对象，然后应删除ClassLoader对象。
class ClassLoader:
    """     
    ...
    from program import network_collection
    from program import generator_collection
    from program import trainor_collection
    from program import inferrence_collection
